    ...
    <div>
      ...
      <div className={styles.mainContainer} style={{ marginTop: 40 }}>
        ...
        <div id='' className={styles.container} >
          <div>
            <h2>Concursos</h2>
            <p>Pennylane Challenge México - IPN, <strong>23 - 24 Octubre 2022</strong></p>
            <p>Entropica LABS Challenge, <strong>22 - 26 Octubre 2022</strong></p>
            <p>Open Hackathon Qiskit Fall Fest México - IPN, <strong>27 Octubre - 2 Noviembre 2022</strong></p>
            <p>The Covalent Challenge México - IPN, <strong>23 - 26 Octubre 2022</strong></p>
            <p></p>
          </div>
        ...
        <div id='talleristas' className={styles.containerSecondary} >
